...
out_path = f"{dataset_name}/outputs/Prediction_results_PathAI_PIFs_Binary_Subtypes/"
...
data_filtered = PathAI_PIFs_with_BRCA_status_full[
    PathAI_PIFs_with_BRCA_status_full[outcome_names].isin(["Positive", "Negative"]).all(axis=1)
]
...
PathAI_PIFs_with_BRCA_status_full
