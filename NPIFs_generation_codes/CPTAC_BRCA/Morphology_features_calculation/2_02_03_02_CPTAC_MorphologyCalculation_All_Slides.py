...
#### ------------------------------------------------------------------------------------------
#### author: Ranjan Barman, date: Feb 17, 2025
...
for json_file in json_files:
    ...
    if tumor_nuclei:
        for key, nucleus in tumor_nuclei.items():
            ...
            # Fit ellipse to calculate major and minor axis lengths
            if len(contour) >= 5:
            ...
            # Store individual nucleus information
