...
#### -------------------------------------------------------------------------------------
#### author: Ranjan Barman, date: Feb 14, 2025
...
slides_path = "/data/Lab_ruppin/dhrubas2/HnE/CPTAC_BRCA/outputs/tiles"

output_base_dir = f"{dataset_name}/HoverNet/outputs/"

os.makedirs(output_base_dir, exist_ok=True) # Creates directory if it doesn't exist already
