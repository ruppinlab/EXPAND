...
#### ---------------------------------------------------------------------------------------------------------------
#### author: Ranjan Barman, date: Jul 24, 2025 (modified for immune only, POST_NAT_BRCA)
#### Compute molecular features (immune nuclei only) from Hover-Net predicted json files (all slides)
#### ---------------------------------------------------------------------------------------------------------------
...
# Dataset name updated to POST_NAT_BRCA
...
features_dir = os.path.join(slide_path, "features3")
...
for json_file in json_files:
    ...
    # Filter only immune nuclei (type = 2)
    ...
    if immune_nuclei:
        for key, nucleus in immune_nuclei.items():
            ...
            # Fit ellipse to get major/minor axis
            if len(contour) >= 5:
            ...
            # Store features
            results.append([slide_folder, tile_name, nucleus_id, area, major_axis, minor_axis, perimeter, eccentricity, circularity])
